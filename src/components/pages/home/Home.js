      ...
      return (
        <div className="bungie-content">
          ...
          <div className="bungie-articles">
            {
              this.state.TWABs.slice(0, 3).map(function(article) {
                return (
                  <div className="bungie-article">
                    <div className="article-name-date">
                      <div className="article-name">{ article.displayName }</div>
                      <div className="article-date">{ Misc.convertTimeToDate(article.creationDate) }</div>
                    </div>
                    <div className="article-image"><a href={`https://bungie.net${article.link}`}><img src={`https://bungie.net${ article.image }`} /></a></div>
                  </div>
                );
              })
            }
      ...
      return(
        <React.Fragment>
          <div className="home-container homeScrollbar">
            ...
            <div className="btn btn-info changelogBtn" onClick={() => { this.toggleChangeLog() }}>View Changelog</div>
