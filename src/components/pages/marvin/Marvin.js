      ...
      <div className="detailsContainer">
        <div className="howToConnect">
          ...
          <div className="paraContainer">
            ...
            <p className="para">Once registered use this command: <span className="d_highlight">~registerclan</span> this will add your clan to list to be scanned. Wait 3 minutes and boom he will be able to give your clan stats!</p>
        ...
        <div className="features">
          ...
          <div className="paraContainer">
            <p className="para">Marvin is used to track clans and give scoreboards to show the progression of your clan.</p>
            <p className="para">This can be useful for many reasons, if you are a clan owner and you feel like your clan needs a bit of spark adding Marvin can help increase the total active time your clan plays as it helps promote healthy competition.</p>
